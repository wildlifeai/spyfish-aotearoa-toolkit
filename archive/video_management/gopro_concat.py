...
def main():
    ...
    if args.toolkit_path:
        ...
        possible_paths = [
            ...
            Path(
                "/nesi/project/wildlife03546/Spyfish-Aotearoa-toolkit"
            ),  # NeSI default
        ...
        for path in possible_paths:
            ...
            logger.warning(
                "Could not auto-detect toolkit path. You may need to specify --toolkit-path"
            )
    ...
    try:
        ...
        num_drops = (
            processor.filtered_df["DropID"].nunique()
            if not processor.filtered_df.empty
            else 0
        )
